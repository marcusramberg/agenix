{
  ...
  outputs =
    ...
    in
    {
      ...
      formatter.riscv64-linux = nixpkgs.legacyPackages.riscv64-linux.alejandra;
      packages.riscv64-linux.agenix = agenix "riscv64-linux";
      packages.riscv64-linux.default = self.packages.riscv64-linux.agenix;
      packages.riscv64-linux.doc = doc "riscv64-linux";
